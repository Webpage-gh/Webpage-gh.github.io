...
function drawScoreboard() {
	...
	if (gameState === 0) {
		...
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 155 * settings.scale, fontSize * 2, "#2c3e50", "旋转六边形");
...
function showText(text) {
	var messages = {
		...
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>按确定开始</div>"
	};
